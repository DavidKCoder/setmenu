...
export default function ProviderHeader({ name, slug, rating, cuisine, location, price, mainImage }) {
    ...
    return (
        <>
            <div
                className="flex h-28 sm:h-40 gap-5 items-center overflow-hidden mb-4 px-3 bg-orange-50 rounded-xl bg-center bg-cover"
                ...
                <div className="ova-section relative h-56 text-center flex flex-col items-center justify-center">
                    <div className={`text-4xl text-white uppercase ${forum_splash.className}`}
                         style={{ fontWeight: 600 }}>
                        {name}
                    </div>

                    {/*<div*/}
                    {/*    className={`absolute whitespace-nowrap uppercase opacity-10 font-medium text-gray-50 tracking-wide ${forum_splash.className} z-0 pointer-events-none animate-fadeIn`}*/}
                    {/*    style={{ fontSize: 160 }}*/}
                    {/*>*/}
                    {/*    {name}*/}
                    {/*</div>*/}
