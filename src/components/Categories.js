...
export default function Categories() {
    ...
    return (
        <section className="relative py-12 px-6 bg-white text-black">
            ...
            <div
                className={`absolute whitespace-nowrap pt-5 uppercase opacity-10 font-medium text-gray-400 tracking-wide ${forum_splash.className} z-0 pointer-events-none`}
                style={{
                    top: -100,
                    right: 400,
                    fontSize: 250
